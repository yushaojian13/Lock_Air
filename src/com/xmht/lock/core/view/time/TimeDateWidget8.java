...
public class TimeDateWidget8  extends TimeDateWidget {
    ...
    public TimeDateWidget8(Context context) {
        this(context, null);
    }

    public TimeDateWidget8(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    
    public TimeDateWidget8(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }
    
    @Override
    protected void setView() {
        LayoutInflater.from(getContext()).inflate(R.layout.widget_time_date_8, this);
