...
//    }
    ...
    public TargetDrawable(AssetManager assetManager, String path) {
        mResourceId = 0;
        setDrawable(assetManager, path);
    }
    ...
    public void setDrawable(AssetManager assetManager, String path) {

        Drawable drawable;
        try {
            drawable = Drawable.createFromStream(assetManager.open(path), null);
        } catch (IOException e) {
            drawable = null;
        }
        mDrawable = drawable != null ? drawable.mutate() : null;
